...
namespace Laerdal.Xamarin.FFmpeg
{
    internal abstract class BaseFFmpegConfigImplementation
    {
        ...
        /// </summary>
        public abstract void EnableRedirection();
        
        /// <summary>
        /// Disables log and statistics redirection.
        /// </summary>
        public abstract void DisableRedirection();
        ...
        /// </summary>
        public abstract string FontconfigConfigurationPath { set; }
        ...
        public abstract void SetFontDirectory(string fontDirectoryPath, IDictionary<string, string> fontNameMapping);
        ...
        /// </summary>
        public abstract string[] ExternalLibraries { get; }
        ...
        public abstract string RegisterNewFFmpegPipe();

        /// <summary>
        /// Closes a previously created FFmpeg pipe.
        /// </summary>
        /// <param name="ffmpegPipePath">full path of ffmpeg pipe</param>
        public abstract void CloseFFmpegPipe(string ffmpegPipePath);

        /// <summary>
        /// Returns FFmpeg version bundled within the library.
        /// </summary>
        public abstract string FFmpegVersion { get; }
        ...
        /// </summary>
        public abstract int LastReturnCode { get; }
        ...
        /// </summary>
        public abstract string LastCommandOutput { get; }
